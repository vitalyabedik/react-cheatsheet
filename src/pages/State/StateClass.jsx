...
const ClassState = () => {
    return (
        <>
            ...
            <Paragraph>
                <Text keyboard>State</Text> - переменная которую нужно изменять
                и которая является объектом.
            </Paragraph>
            ...
            <Paragraph>
                <ol>
                    <li>
                        <Text keyboard>С помощью конструктора</Text> - очень
                        долго, т.к. нужно написать constructor, super и тд.
                    </li>
            ...
            <Paragraph>
                <ol>
                    ...
                    <li>
                        Второй параметр - callback-функция, которая сработает,
                        когда state обновится:
                    </li>
                    <Paragraph>
                        <Text keyboard>
                            Иногда может быть полезен, когда у нас есть какое-то
                            значение и затем это измененное значение нужно
                            отправить на сервер.
                        </Text>
                    </Paragraph>
                </ol>
            ...
            <Paragraph>
                Его нельзя вызывать в методе render, иначе будет ошибка, т.к.
                произойдет зацикливание.
            </Paragraph>
            <Paragraph>
                Это происходит по той причине, что каждый вызов setState
                вызывает метод render из-за чего происходит rerender
            </Paragraph>
            <Paragraph>
